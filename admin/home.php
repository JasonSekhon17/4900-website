     ...
     <div class="container">
        <div class="row">
           <div class="col-md-5">
              <!-- Logo -->
              <div class="logo">
                 <h1><a href="index.html">Wash And Fold Admin</a></h1>
              </div>
           </div>
  ...
  <div class="page-content">
    ...
    <div class="col-md-2">
      <div class="sidebar content-box" style="display: block;">
              <ul class="nav">
                  <!-- Main menu -->
                  <li class="current"><a href="index.html"><i class="fa fa-home"></i> Dashboard</a></li>
                  <li><a href="create.php"><i class="fa fa-calendar"></i> Create Accounts</a></li>
                  <li><a href="orders.php"><i class="fa fa-bar-chart"></i> Orders</a></li>
                  <li><a href="stats.php"><i class="fa fa-list"></i> Stats</a></li>
                  <li><a href="https://dashboard.tawk.to/login"><i class="fa fa-circle-o"></i> Messages</a></li>
              </ul>
           </div>
    </div>
    <div class="col-md-10">
      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4 panel-warning">
